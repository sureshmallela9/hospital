...
/*
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
		dataSource.setUrl("jdbc:sqlserver://192.168.100.235;databaseName=incident_report");
		dataSource.setUsername("iropd");
		dataSource.setPassword("N@pier@54321");

		DriverManagerDataSource dataSource1 = new DriverManagerDataSource();
		dataSource1.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
		dataSource1.setUrl("jdbc:sqlserver://192.168.100.235;databaseName=star");
		dataSource1.setUsername("iropd");
		dataSource1.setPassword("N@pier@54321");

		DriverManagerDataSource defaultSchema = new DriverManagerDataSource();
		defaultSchema.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
		defaultSchema.setUrl("jdbc:sqlserver://192.168.100.235;databaseName=defaultSchema");
		defaultSchema.setUsername("iropd");
		defaultSchema.setPassword("N@pier@54321");*/
